...
int main(int argc, char *argv[]) {
    ...
    if (yyparse(&root) == 0) {
        ...
        // Print to human-readable result file
        ...
        fclose(jsonFile);
        printf("Parse tree written to tree.json\n");
